...
@section('content')
    ...
    <form method="POST" action="{{ route('customers.update', $customer->id) }}">
            ...
            <div class="col-12 col-md-6 mb-2 mb-md-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" name="address_line_1" id="address_line_1" class="form-control"
                           required autocomplete="address_line_1" value="{{ $customer->address_line_1 }}">
            ...
            <div class="col-12 col-md-6 mb-2 mb-md-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" name="address_line_2" id="address_line_2" class="form-control"
                           required autocomplete="address_line_2" value="{{ $customer->address_line_2 }}">
            ...
            <div class="col-12 col-md-6 mb-2 mb-md-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" name="region" id="region" class="form-control"
                           required autocomplete="region" value="{{ $customer->region }}">
            ...
            <div class="col-12 col-md-6 mb-2 mb-md-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" name="country" id="country" class="form-control"
                           required autocomplete="country" value="{{ $customer->country }}">
            ...
            <div class="col-12 col-md-6 mb-2 mb-md-4">
                <div data-mdb-input-init class="form-outline">
                    <input type="text" name="postal_code" id="postal_code" class="form-control"
                           required autocomplete="postal_code" value="{{ $customer->postal_code }}">
        ...
        <div class="row g-1">
            <div class="col">
                <input type="hidden" name="user_id" value="{{ $customer->user_id ?? '0' }}">
